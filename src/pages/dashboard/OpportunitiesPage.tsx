...
import { fetchAllOpportunities } from "@/api/opportunityApi";
...
const OpportunitiesPage: React.FC = () => {
  ...
  // For demo purposes, show static opportunities if none are in the database yet
  const hasRealOpportunities = opportunities && opportunities.length > 0;
  
  // Mock data for when no opportunities exist yet
  const mockOpportunities = [
    ...
    },
    {
      ...
      duration: "Ongoing",
      is_new: false,
      brand_name: "RunGear Pro"
    }
  ];
  
  // Use real data if available, otherwise use mock data
  const displayedOpportunities = hasRealOpportunities ? opportunities : mockOpportunities;
          ...
          <>
            <div className="mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {displayedOpportunities.slice(0, 2).map((opportunity: any) => (
                  <Card 
                    key={opportunity.id} 
                  ...
                  >
                    <div className="p-6">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-medium">By {opportunity.brand_name || "Brand"}</span>
                        {opportunity.is_new && (
            ...
            <div>
              ...
              <div className="space-y-4">
                {displayedOpportunities.slice(2).map((opportunity: any) => (
                  <Card 
                    key={opportunity.id} 
                    ...
                    <div className="p-4 flex flex-col md:flex-row md:items-center">
                      <div className="md:flex-1">
                        ...
                        <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-500">
                          ...
                          <div>
                            <span className="font-medium">By {opportunity.brand_name || "Brand"}</span>
                          </div>
                        </div>
                      </div>
            ...
            {displayedOpportunities.length > 4 && (

      ...
      <div className="container-custom py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-lg text-white">RunConnect</span>
            </Link>
            <p className="text-white/70 mb-4">
              Australia's premier platform connecting run clubs with brands looking for authentic partnerships.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/support" className="hover:text-orange-400">Support Center</Link></li>
              <li><Link to="/guides" className="hover:text-orange-400">Guides</Link></li>
              <li><Link to="/partners" className="hover:text-orange-400">Partners</Link></li>
              <li><Link to="/testimonials" className="hover:text-orange-400">Testimonials</Link></li>
              <li><Link to="/community" className="hover:text-orange-400">Community</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <svg className="h-5 w-5 mr-2 mt-0.5 text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start">
                ...
                <span>info@runconnect.com.au</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 mr-2 mt-0.5 text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm mb-4 md:mb-0">
            © 2025 RunConnect. All rights reserved.
          </p>
